...
export function buildEmailPreviewCatalog(
  ...
  return [
    ...
    },
    {
      ...
      description: "Approval alert sent to leave voters and the choir inbox.",
    ...
    },
    {
      ...
      description: "Decision email sent to the member and the choir inbox after approval.",
    ...
    },
    {
      ...
      category: "requests",
      title: "Leave Denied",
      description: "Decision email sent to the member and the choir inbox after denial.",
